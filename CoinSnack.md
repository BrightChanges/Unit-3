...
| Criteria 2: The program will print "Email is invalid" on to the  terminal if the client registered an invalid email address.                                                       | When a client register an email address that is not an email address (such as putting in something without a "@"), CoinSnack app will print "Email is invalid" on to the screen.                                                                                                                                   |      |
